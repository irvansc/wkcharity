    ...
    <div class="container text-white py-5">
        <div class="row text-center">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="fa-2x font-weight-bold">{{ format_uang(500000) }}</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="fa-2x font-weight-bold">{{ format_uang(999999) }}</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="fa-2x font-weight-bold">{{ format_uang(99999) }}</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4">
                    <div class="rounded-top" style="height: 200px; overflow: hidden;">
                        @if (asset('/storage').$item->path_image == null)
                        ...
                        @else
                        <img src="{{ asset('/storage').$item->path_image}}" class="card-img-top" alt="...">
                        @endif
                    </div>
                    ...
                    <div class="card-body card-body2 p-2 border-top">
                        <a href="{{ url('/donation/'. $item->id) }}" class="card-title  mb-3">{{ $item->title }}</a>
