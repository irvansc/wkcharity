                ...
                <div class="card">
                    <div class="card-body d-flex">
                        <div class="thumbnail rounded w-25" style="overflow: hidden">
                            ...
                            <img src="{{ Storage::disk('public')->url($campaign->path_image) }}" class="w-100"
                                alt="...">
                            @else
                    ...
                    <div class="card-body">
                        <div class="bg-light rounded d-flex align-items-center p-3">
                            ...
                            <div class="form-group w-75">
                                <input type="text" class="form-control @error('nominal') is-invalid @enderror"
                                    name="nominal" placeholder="Masukan nominal donasi" value="{{ old('nominal') }}"
                        ...
                        <div class="form-group">
                            <textarea name="support" id="support" rows="4" class="form-control"
                                placeholder="Tulis dukungan atau doa untuk penggalangan dana ini. Contoh: Semoga cepet sembuh, ya!">{{ old('support') }}</textarea>
                        </div>
                    </div>
                </div>
