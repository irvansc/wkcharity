...
<div class="row">
    <div class="col-lg-7">
        ...
        <div class="pre alert alert-light border-primary">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    @if ($bank)
                    <input type="text" class="form-control-plaintext bank-account" value="{{ $bank->pivot->account }}"
                        readonly>
                    @endif
                </div>
                <div class="col-lg-4">
                    ...
                    @if ($bank)
                    <input type="text" class="form-control-plaintext bank-ownername" value="{{ $bank->pivot->name }}"
                        readonly>
                    @endif
                </div>
            </div>
        ...
        <x-card class="card-confirm">
            <x-slot name="header">
                <h5 class="mb-0">Dibuat pada {{ tanggal_indonesia($cashout->created_at) }} {{ date('H:i',
                    strtotime($cashout->created_at)) }}</h5>
            </x-slot>
