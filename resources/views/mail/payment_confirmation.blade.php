                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="text-center mt-3 mt-lg-4">
                            Harap transfer sesuai dengan nominal "<strong>TOTAL TAGIHAN</strong>" ke bank yang tertera
                            di atas! Setelah transfer lakukan konfirmasi! perbedaan nilai transfer akan menghambat
                            proses verfikasi.
                        </p>

                        <div class="text-center mt-3 mt-lg-4">
                            <a href="{{ url('/donation/'. $campaign->id .'/payment-confirmation/'. $donation->order_number) }}"
                    ...
                    <p><a
                            href="{{ url('/donation/'. $campaign->id .'/payment-confirmation/'. $donation->order_number) }}">{{ url('/donation/'. $campaign->id .'/payment-confirmation/'. $donation->order_number) }}</a>
                    </p>
