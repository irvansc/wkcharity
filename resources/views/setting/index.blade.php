...
<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link @if (request('pills') == '') active @endif" href="{{ route('setting') }}">Identitas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request('pills') == 'logo') active @endif" href="{{ route('setting') }}?pills=logo">Logo</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request('pills') == 'sosial-media') active @endif" href="{{ route('setting') }}?pills=sosial-media">Sosial Media</a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request('pills') == 'bank') active @endif" href="{{ route('setting') }}?pills=bank">Bank</a>
            </li>
        </ul>
