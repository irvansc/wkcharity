        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <form class="form-group" action="{{ url('/donation') }}">
                    <select name="" id="categories" class="select2" multiple required 
                        style="width: 100%;"
                        onchange="">
                        <option value=""></option>
                    </select>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between text-dark">
                            <p class="mb-0">Terkumpul: <strong>Rp. 9000.000</strong></p>
                            <p class="mb-0">Goal: <strong>Rp. 9000.000</strong></p>
                        </div>
                    </div>
                    <div class="card-body card-body2 p-2 border-top">
                        <a href="" class="card-title text-dark mb-3"></a>
